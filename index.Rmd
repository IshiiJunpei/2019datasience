...
# htmlファイル
render("index.Rmd",html_document(toc = TRUE, theme =  "cosmo"),"document.html")

 ("default", "cerulean", "journal", "flatly",
          "darkly", "readable", "spacelab", "united", "cosmo", "lumen",
          "paper", "sandstone", "simplex", or "yeti"
# README.mdファイル
render("index.Rmd",output_format="md_document","README.md")
# revealjsスライド
render("index.Rmd",revealjs::revealjs_presentation(theme="solarized",transition="convex"),"index.html")
# オブション
 theme: Visual theme ("simple", "sky", "beige", "serif", "solarized",
          "blood", "moon", "night", "black", "league" or "white").
transition: Slide transition ("default", "none", "fade", "slide",
          "convex", "concave" or "zoom")
background_transition: Slide background-transition ("default", "none",
